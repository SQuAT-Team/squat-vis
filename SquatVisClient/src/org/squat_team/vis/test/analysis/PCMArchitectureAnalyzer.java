...
public class PCMArchitectureAnalyzer {
	 ...
	 */
	public PCMArchitectureAnalyzer(CLevel level) {
		this.level = level;
	}
	...
	private void exportArchitectureFiles(CCandidate candidate) throws IOException {
		...
		String tempDirectoryPrefix = "p" + "l" + level.getLevelNumber() + "c"
	...
	public ArchitectureAnalysisData analyzeCandidateStatic(CCandidate candidate) throws IOException {
